...
var CreateProductService = /** @class */ (function () {
    ...
    CreateProductService.prototype.execute = function (_a) {
        var name = _a.name, description = _a.description, price = _a.price, promoPrice = _a.promoPrice, statusFlag = _a.statusFlag, imageUrl = _a.imageUrl, categoryTitle = _a.categoryTitle;
        return __awaiter(this, void 0, void 0, function () {
            var productsRepository, categoriesRepository, category, newCategory, product;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, productsRepository.verifyCategory(categoryTitle)];
                    case 1:
                        category = _b.sent();
                        ...
                        return [4 /*yield*/, categoriesRepository.save(newCategory)];
                    case 2:
                        category = _b.sent();
                        _b.label = 3;
                    case 3:
